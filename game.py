...
for num in range(no_of_invaders):
    ...
    invader_Xchange.append(2) # invader speed about x axis
...
GPIO.add_event_detect(MIC, GPIO.BOTH, bouncetime=300)  # let us know when the pin goes HIGH or LOW
GPIO.add_event_callback(MIC, callback)  # assign function to GPIO PIN, Run function on change
